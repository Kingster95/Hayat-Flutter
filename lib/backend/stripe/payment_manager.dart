...
const _kProdStripePublishableKey =
    'pk_live_51MLrX6ChaH17soxJP7LfesdUZEQhzqCy8jRCigoU0DZkFinOI62sNIUCjjiiqzPqY0pGYiTqqBv3VtcHZooWnE3000tgaxJLkp';
const _kTestStripePublishableKey =
    'pk_test_51MLrX6ChaH17soxJ2OFcK9q9qoMzeuXiOM9bkTeMWnBCXDI5dIAabyQoyFaPanyaThrBuHSNcLhz0i8RmtWcLCvN00fG5DhJK0';
const _kAppleMerchantId = 'merchant.com.mycompany.aplicatie';
  ...
  try {
    ...
    await Stripe.instance.initPaymentSheet(
      paymentSheetParameters: SetupPaymentSheetParameters(
        ...
        merchantDisplayName: 'Hayat Art SRL',
        googlePay: allowGooglePay
            ? PaymentSheetGooglePay(
                merchantCountryCode: 'ROU',
